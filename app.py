...
with st.sidebar:
    ...
    if lang_choice != st.session_state.lang:
        ...
        st.rerun()
    st.divider()
    selected = option_menu(None, [cur["dash"], cur["tutor"], cur["history"], cur["settings"]], icons=["grid-1x2-fill", "cpu-fill", "clock-history", "sliders"], default_index=0, styles={"container": {"background-color": "transparent"}, "nav-link": {"color": "#e0e0e0"}, "nav-link-selected": {"background-color": "rgba(0, 209, 255, 0.15)", "color": "#00D1FF", "border": "1px solid #00D1FF"}})
    st.divider()
