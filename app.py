...
# --- 2. עיצוב Vivid & Live (צבעוני וחדשני) ---
st.markdown("""
    <style>
    /* רקע מדורג חי */
    ...
    /* בועות צ'אט ברורות */
    [data-testid="stChatMessage"] { background: rgba(0, 0, 0, 0.3) !important; border-radius: 15px; border: 1px solid rgba(0, 212, 255, 0.2); }
