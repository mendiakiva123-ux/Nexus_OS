...
def get_ai_response_stream(subject, prompt, file_context=""):
    try:
        ...
        system_instruction = (
            f"You are Nexus OS AI, an elite academic assistant. Subject: {subject}. "
            "Structure your response with headers and bullet points. Respond in Hebrew."
        )
